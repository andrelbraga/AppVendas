...
public $email;
public $empresa;
public $enderecoComercial;
public $enderecoResidencial;
public $estado;
public $estadoCivil;
public $estadoEmpresa;
public $funcao;
public $grauParentescoDois;
public $grauParentescoUm;
public $marcaModelo;
...
public $nomeMae;
public $nomePai;
public $nomeReferenciaDois;
public $nomeReferenciaUm;
public $numeroComplemento;
public $numeroComplementoEmpresa;
...
public $telefoneContador;
public $telefoneEmpresa;
public $telefoneFixoDois;
public $telefoneFixoUm;
